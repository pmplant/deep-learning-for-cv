...
\abstract{In this assignment, I finished implementing a linear classifier. I
  derived the gradient for multinomial logistic regression and implemented it. I
  also finished implementing the training routine and cross validation.
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.60]{ihog_logreg_cv_lre4_loss}
  \caption{Validation Loss.}
  \label{fig:eg}
\end{figure}
\pagebreak
